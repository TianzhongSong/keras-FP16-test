...
if __name__ == '__main__':
    ...
    parser.add_argument("--images", type=str, default='./data/images_prepped_train/')
    parser.add_argument("--annotations", type=str, default='./data/annotations_prepped_train/')
