...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        # revised
        boxes_tensor = K.tile(K.constant(boxes_tensor, dtype=self.dtype), (K.shape(x)[0], 1, 1, 1, 1))
        # boxes_tensor = K.tile(K.constant(boxes_tensor, dtype='float16'), (K.shape(x)[0], 1, 1, 1, 1))
